...
echo "#Name 	  RES		Lat        wLon	           FB0        FB1        FB2        FB3       FB4      FB5a       FB5b       FB6a       FB6b      FB7      PStations OA1 OA2 OA3 OA4 OB1 OB2" > eval/evalStation.txt 
...
do
 ...
 echo "$info $FB0 $FB1 $FB2 $FB3       $FB4 $FB5a $FB5b $FB6a $FB6b       $FB7        $Stat         $OA1   $OA2   $OA3   $OA4   $OB1   $OB2" >> eval/evalStation.txt
