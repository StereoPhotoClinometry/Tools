...
list="MAPINFO.TXT PICINFO.TXT RESIDUALS.TXT LMKVECS.TXT check.txt veto.txt RANGES_SOLVED.TXT EMPTY.TXT no_udpate.txt LIMINFO.TXT MAPCHK.TXT MAPRES.TXT PRUDE.TXT FLATLIST.TXT New_Limbs.in"
for item in $list
do
	if [ -e $item ]
	then
